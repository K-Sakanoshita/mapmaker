...
$.fn.simpleColorPicker = function (options) {
	...
	return this.each(function () {
		...
		let div = prefix.indexOf("BAK") == -1 ? `<div class="d-flex align-items-center" style="background-color: white">${range}</div>` : "";
		...
		txt.click(function (event) {
			...
			if (!txt.is('input')) {
				...
				let key = box.attr('id').substr(0, 3);
