...
$.fn.simpleColorPicker = function(options) {
	var defaults = {
		colorsPerLine: 8,
		colors: [
					'#000000', '#888888', '#aaaaaa', '#cccccc', '#eeeeee', '#e8e8e8', '#f0f0f0', '#ffffff'
				, '#ff0000', '#ff9900', '#ffff00', '#00ff00', '#00ffff', '#0000ff', '#9900ff', '#ff00ff'
				, '#fad4d4', '#ffecd5', '#ffffdd', '#e0f8e0', '#d8e8ea', '#d7eafa', '#e3daf5', '#f4d9e4'
				...
				, '#330000', '#3C2002', '#403000', '#11280A', '#071B1F', '#041C31', '#150A28', '#280A17'
				],
		showEffect: '',
		hideEffect: '',
		onChangeColor: false,
