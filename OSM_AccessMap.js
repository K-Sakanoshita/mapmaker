...
var MakeDatas = {						// 制御情報の保管場所
	GDN: {type: "way",	name: "公園・庭",color:"#C8FACC",width: 0,	dashArray:null},
	RIV: {type: "way",	name: "水路・川",color:"#66AAFF",width: 1,	dashArray:null},
	FRT: {type: "way",	name: "森・田畑",color:"#ADD19E",width: 0,	dashArray:null},
	BLD: {type: "way",	name: "建物・家",color:"#EEEEEE",width: 0,	dashArray:null},
	RIL: {type: "way",	name: "レール類",color:"#404040",width: 1,	dashArray:null},
	PRI: {type: "way",	name: "主要道路",color:"#FF7777",width: 4,	dashArray:null},
	STD: {type: "way",	name: "一般道路",color:"#A0A0A0",width: 2,	dashArray:null},
	COM: {type: "way",	name: "生活道路",color:"#C0C0C0",width: 1,	dashArray:null},
	ALY: {type: "way",	name: "路地小道",color:"#F6B26B",width: 1,	dashArray:"10,2"},
	SIG: {type: "node",	name: "信号関連",icon: "./image/signal.svg",size: [18,34]}
};
...
$(document).ready(function() {
	...
	$.when.apply($, jqXHRs).done(function(){
		//$("#basemenu").html(arguments[0][0]);
		$("#basemenu").html(arguments[0]);																								// 配列が一つの時は処理が異なる
